<?php include ("sessions.php");
    ...
    {
        $get_pass_sql = "select * from mumbo_user where user_email = '" . $clean_user_name . "'";
        $get_pass_res = mysqli_query($connect, $get_pass_sql)
            or die (mysqli_error($connect) . "\n Error checking username.");
    }
    ...
    {        
        ...
        {   
            ...
            $display_block = "Weclome, " . $array['user_name'] . "!";
        ...
        $display_block = "Sorry, username/email <strong>" . $clean_user_name . "</strong> not found,
        <a href = 'loginForm.php' style = 'font-weight: bold'>please try again!</a>";
    }
