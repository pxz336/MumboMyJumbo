...
=======
    ...
    //Creates safe values for input
    $clean_title = mysqli_real_escape_string($connect, $_POST['artTitle']);
    $clean_text = mysqli_real_escape_string($connect, $_POST['artText']);
    ...
    if ($check_dup_email_res->num_rows != 0) { //need to edit this and above
        $duplicate_title = true;
    }

    if ($duplicate_title == false) {
